...
class AdminAddressController:
    def __init__(self, api):
        self.api = api
        self.admin_address_model = api.model(
            "AdminAddress",
            {
                ...
                "address2": fields.String(
                    required=False, description="Admin Address 2"
                ),
                ...
                "address_type": fields.String(
                    ...
                    enum=["current_address", "permanent_address"],
                ),
            },
        )
        ...
        self.admin_address_ns = Namespace(
            "admin_address",
            description="Admin Address Details",
    ...
    def calculate_completion_percentage(self):
        ...
        return (
            round((len(self.required_fields) / total_required_fields) * 100, 2)
        ...
        class AdminAddressAdd(Resource):
            ...
            def post(self):
                try:
                    ...
                    if not address1:
                        return jsonify(
                            {"message": "Please Provide Address 1", "status": 201}
                        )

                    if not country:
                        return jsonify(
                            {"message": "Please Provide Country", "status": 201}
                        )
                    if not state:
                        return jsonify(
                            {"message": "Please Provide State", "status": 201}
                        )
                    if not city:
                        return jsonify(
                            {"message": "Please Provide City", "status": 201}
                        )
                    if not district:
                        return jsonify(
                            {"message": "Please Provide District", "status": 201}
                        )
                    if not pincode:
                        return jsonify(
                            {"message": "Please Provide Pincode", "status": 201}
                        )
                    if not address_type:
                        return jsonify(
            ...
            def get(self):
                try:
                    ...
                    if not admin_addresses_data:
                        return jsonify(
                            {"message": "No Admin Addresses found", "status": 404}
                        )
                    else:
                        return jsonify(
                            {
        ...
        class AdminAddressEdit(Resource):
            ...
            def put(self, id):
                try:
                    ...
                    if not address2:
                        return jsonify(
                            {"message": "Please Provide Address 2", "status": 201}
                        )
                    if not country:
                        return jsonify(
                            {"message": "Please Provide Country", "status": 201}
                    ...
                    if not address_type:
                        ...
                        admin_address = AdminAddress.query.filter_by(
                            admin_id=id, address_type=address_type
                        ).first()
