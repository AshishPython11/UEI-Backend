...
class AdminBasicInformationController:
    def __init__(self, api):
        self.api = api
        self.admin_basicinfo_model = api.model(
            "AdminBasicInformation",
            {
                "department_id": fields.String(
                    required=True, description="Department Id"
                ),
                "first_name": fields.String(
                    required=True, description="Admin First Name"
                ),
                "last_name": fields.String(
                    required=True, description="Admin Last Name"
                ),
                ...
                "father_name": fields.String(
                    required=True, description="Admin Father Name"
                ),
                "mother_name": fields.String(
                    required=True, description="Admin Mother Name"
                ),
                "guardian_name": fields.String(
                    required=True, description="Admin Gaurdian Name"
                ),
                "is_kyc_verified": fields.Boolean(
                    required=False, description="Admin KYC verified"
                ),
                "pic_path": fields.String(required=True, description="Admin Pic path"),
                "admin_login_id": fields.String(
                    required=True, description="Admin Login Id"
                ),
            },
        )
        ...
        self.admin_basicinfo_ns = Namespace(
            "admin_basicinfo",
            description="Admin Basic Information Details",
    ...
    def calculate_completion_percentage(self, data):
        filled_fields = sum(
            1 for field in self.required_fields if field in data and data[field]
        )
        total_required_fields = len(self.required_fields)
        return (
            (filled_fields / total_required_fields) * 100
    ...
    def register_routes(self):
        ...
        class AdminBasicInformationList(Resource):
            ...
            def get(self):
                try:
                    admin_basicinfoes = AdminBasicInformation.query.filter_by(
                        is_active=1
                    ).all()
                    ...
                    if not admin_basicinfoes_data:
                        return jsonify(
                            {
                                "message": "No Admin Basic Information found",
                                "status": 404,
                            }
                        )
                    else:
                        return jsonify(
                            {
                                "message": "Admin Basic Informations found Successfully",
                                "status": 200,
                                "data": admin_basicinfoes_data,
                            }
                        )
        ...
        class AdminBasicInformationAdd(Resource):
            ...
            def post(self):
                try:
                    data = request.json
                    last_data = AdminBasicInformation.query.order_by(
                        AdminBasicInformation.admin_id.desc()
                    ).first()
                    ...
                    if not department_id:
                        return jsonify(
                            {"message": "Please Provide Department Id", "status": 201}
                        )
                    if not first_name:
                        return jsonify(
                            {"message": "Please Provide First Name", "status": 201}
                        )
                    if not last_name:
                        return jsonify(
                            {"message": "Please Provide Last Name", "status": 201}
                        )
                    if not gender:
                        return jsonify(
                            {"message": "Please Provide Gender", "status": 201}
                        )
                    if not dob:
                        return jsonify(
                            {"message": "Please Provide Date of Birth", "status": 201}
                        )
                    if not father_name:
                        return jsonify(
                            {"message": "Please Provide Father Name", "status": 201}
                        )
                    if not mother_name:
                        return jsonify(
                            {"message": "Please Provide Mother Name", "status": 201}
                        )

                    if not admin_login_id:
                        return jsonify(
                            {"message": "Please Provide Logged Admin Id", "status": 201}
                        )
                    else:
                        admin_basicinfo = AdminBasicInformation(
                        ...
                        return jsonify(
                            {
                                "message": "Admin Basic Information created successfully",
                                "status": 200,
                            }
                        )
                except Exception as e:
            ...
            def put(self, id):
                try:
                    ...
                    if not admin_login_id:
                        ...
                        admin_basicinfo = AdminBasicInformation.query.filter_by(
                            admin_login_id=id
                        ).first()
                        if not admin_basicinfo:
                            return jsonify(
                                {
                                    "message": "Admin Basic Information not found",
                                    "status": 404,
                                }
                            )
                        else:
                            ...
                            return jsonify(
                                {
                                    "message": "Admin Basic Information updated successfully",
                                    "status": 200,
                                }
                            )
                except Exception as e:
            ...
            def get(self, id):
                try:
                    ...
                    if not admin_basicinfo:
                        ...
                        return jsonify(
                            {
                                "message": "Admin Basic Information found Successfully",
                                "status": 200,
                                "data": admin_basicinfo_data,
                            }
                        )
                except Exception as e:
                    return jsonify({"message": str(e), "status": 500})
        ...
        class AdminGetProfile(Resource):
            ...
            def get(self, id):
                try:
                    ...
                    admin = AdminBasicInformation.query.filter_by(
                        admin_login_id=id
                    ).first()
                    if not admin:
                        ...
                        admin_address = (
                            AdminAddress.query.filter_by(admin_id=id)
                            .order_by(AdminAddress.admin_address_id.desc())
                            .first()
                        )
                        admin_description = (
                            AdminDescription.query.filter_by(admin_id=id)
                            .order_by(AdminDescription.id.desc())
                            .first()
                        )
                        admin_profession = (
                            AdminProfession.query.filter_by(admin_id=id)
                            .order_by(AdminProfession.id.desc())
                            .first()
                        )
                        admin_language_known = (
                            AdminLanguageKnown.query.filter_by(admin_id=id)
                            .order_by(AdminLanguageKnown.id.desc())
                            .first()
                        )
                        admin_contact = (
                            AdminContact.query.filter_by(admin_id=id)
                            .order_by(AdminContact.admin_contact_id.desc())
                            .first()
                        )
                        admin_contact_data = {}
            ...
            def put(self, id):
                try:
                    ...
                    if not admin_basicinfo:
                        ...
                        return jsonify(
                            {
                                "message": "Admin Basic Information activated successfully",
                                "status": 200,
                            }
                        )
                except Exception as e:
            ...
            def put(self, id):
                try:
                    ...
                    if not admin_basicinfo:
                        ...
                        return jsonify(
                            {
                                "message": "Admin Basic Information deactivated successfully",
                                "status": 200,
                            }
                        )
                except Exception as e:
