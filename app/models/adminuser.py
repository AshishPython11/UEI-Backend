...
class AdminBasicInformation(db.Model,TimestampMixin):
    ...
    admin_id = db.Column(db.Integer, primary_key=True,autoincrement=True)
    admin_login_id = db.Column(db.Integer, db.ForeignKey('tbl_admin_login.admin_id'),nullable=True)
    admin_registration_no = db.Column(db.String(255))
    department_id = db.Column(db.Integer,db.ForeignKey('tbl_department_master.department_id'), nullable=False)  # References department_master table
...
class AdminAddress(db.Model,TimestampMixin):
    ...
    admin_address_id = db.Column(db.Integer, primary_key=True,autoincrement=True)
    admin_id = db.Column(db.Integer, db.ForeignKey('tbl_admin_login.admin_id'),nullable=False)
...
class AdminContact(db.Model,TimestampMixin):
    ...
    admin_contact_id = db.Column(db.Integer, primary_key=True,autoincrement=True)
    admin_id = db.Column(db.Integer, db.ForeignKey('tbl_admin_login.admin_id'),nullable=False)
...
class AdminLanguageKnown(db.Model,TimestampMixin):
    ...
    admin_id = db.Column(db.Integer, db.ForeignKey('tbl_admin_login.admin_id'), nullable=False)
    language_id = db.Column(db.Integer, db.ForeignKey('tbl_language_master.language_id'), nullable=False)
...
class AdminProfession(db.Model,TimestampMixin):
    ...
    id = db.Column(db.Integer, primary_key=True,autoincrement=True)
    admin_id = db.Column(db.Integer, db.ForeignKey('tbl_admin_login.admin_id'), nullable=False)
    institution_id = db.Column(db.Integer, db.ForeignKey('tbl_institutions.institution_id'), nullable=False)
    course_id = db.Column(db.Integer, db.ForeignKey('tbl_course_master.course_id'), nullable=False)  # References course table
    subject_id = db.Column(db.Integer, db.ForeignKey('tbl_subject_master.subject_id'), nullable=False)  # References subject tablecl
    is_active = db.Column(db.Integer, default=1, nullable=False)
    created_by = db.Column(db.String, nullable=True)
    updated_by = db.Column(db.String, nullable=True)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.now())
...
class Institution(db.Model,TimestampMixin):
    ...
    entity_id = db.Column(db.Integer, db.ForeignKey(EntityType.entity_id), nullable=True)
